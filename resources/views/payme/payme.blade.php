                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('cardsCreate') }}" method="post">
                        ...
                        <div class="md-form">
                            ...
                            <input type="text" id="expire" class="form-control" name="expire" placeholder="00/00"
                                maxlength="10">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <form action="{{ route('pay.reset') }}" method="post" style="display: inline">
                                @method('post')
                                @csrf
                                <button class="btn btn-deep-orange" type="submit">Reset</button>
                            </form>
                        </div>
